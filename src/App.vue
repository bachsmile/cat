<template>
  <div id="app-root">
    ...
    <SystemOnboarding
      ref="onboardingRef"
      @on-show="handleOnboardingVisible"
      @on-hide="handleOnboardingHidden"
    />

    <!-- Use v-if to completely prevent rendering if we are in onboarding mode -->
    <main
      v-if="!isForceHidden"
      :class="{ 'opacity-0': isOverlayingOnboarding }"
...
import CxToastProvider from "./components/common/cx/CxToastProvider.vue";
