<template>
  ...
  >
    ...
    >
      ...
      <h3 class="text-2xl font-bold mb-6">Nạp Tài Sản</h3>
      ...
      <form @submit.prevent="$emit('submit')" class="space-y-5">
        ...
        <div
          class="p-5 bg-gradient-to-br from-purple-500/10 to-indigo-500/10 border border-purple-500/20 rounded-2xl mt-8"
        >
          <p
